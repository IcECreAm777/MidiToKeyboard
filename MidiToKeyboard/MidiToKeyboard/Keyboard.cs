...
{
    /// <summary>
    /// Credits to a kind answer on StackOverflow
    /// <see cref="https://stackoverflow.com/questions/20482338/simulate-keyboard-input-in-c-sharp"/>
    /// </summary>
    internal class Keyboard
    {
        ...
        public void SendKeyUp(ScanCodeShort key)
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 1;
        ...
        public enum VirtualKeyShort : short
        {
            ...
            VOLUME_DOWN = 0xAE,
            ///<summary>
            ///Windows 2000/XP: Volume SendKeyUp key
            ///</summary>
            VOLUME_UP = 0xAF,
            ///<summary>
